...
function createPersistenceInterface(options) {
  ...
  function set(key, value) {
    ...
    storage.setItem(storageKey, (0, _stringify.default)(data));
  }
...
function _default(registry, pluginOptions) {
    ...
    return function (result) {
      ...
      if (state !== lastState) {
        if (Array.isArray(keys)) {
          state = (0, _lodash.pick)(state, keys);
        }
  ...
  return {
    registerStore: function registerStore(reducerKey, options) {
      ...
      store.dispatch = (0, _lodash.flow)([store.dispatch, createPersistOnChange(store.getState, reducerKey, options.persist)]);
      return store;
    }
  };
}
